...
public class GenericRequest<T> extends JsonRequest<T> {
    ...
    private final Type typeJsonConverter;
     ...
     * @param headers:       Added headers
     */
    public GenericRequest(String url, Type classtype, Response.Listener<T> listener, Response.ErrorListener errorListener, Map<String, String> headers, boolean hasModel) {
        super(Request.Method.GET, url, "", listener,
                errorListener);
        this.hasModel = hasModel;
        this.clazz = null;
        this.headers = headers;
        this.typeJsonConverter = classtype;
    }
